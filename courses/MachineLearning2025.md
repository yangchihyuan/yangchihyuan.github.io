...
|4   |以序列為基礎的 Promoter/Enhancer 辨識：傳統機器學習與 DNABERT-2 之比較分析      |                        |        | |
|5   |利用 CNN 辨識「回收分類：紙類 / 塑膠 / 金屬」照片      |                        |        | |
|6   |宏觀經濟因子的 P2P 借貸 ROI 預測      |                        |        | |
|7   |使用卷積神經網路於蘋果葉病害之影像分類研究      |                        |        | |
|8   |使用強化學習訓練 AI 征服 osu!：從零到高手的完整指南                      |                        |        | |
|9   |急診壅塞情境下之智慧病患分流與資源配置決策支援系統                       |                        |        | |
|10  |若臺灣防疫不成功：以 TWCDC 資料集建構 COVID-19 反事實模擬                |                        |        | |
|11  |啊我的腳踏車勒？      |                        |        | |
|12  |運用AI影像辨識模型分辨iphone 型號                |                        |        | |
|13  |應用 AlphaZero 架構的五子棋智能對弈模型          |                        |        | |
